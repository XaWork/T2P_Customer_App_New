...
class OrderConfirmUseCase @Inject constructor(
    ...
    ): Flow<Resource<OrderConfirmModel>> {
        return flow {
            emit(Resource.Loading(true))
            try {
                val response = repo.confirmOrder(isWalletApplied, gateWay, orderId, transactionId)
